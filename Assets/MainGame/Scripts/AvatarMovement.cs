...
public class AvatarMovement : MonoBehaviour
{
    ...
    private IEnumerator FallAfterHit()
    {
        ...
        MoveCameraToMenuTarget(); // No smooth transition here
    ...
    private void MoveCameraToMenuTarget()
    {
       // mainCamera.transform.position = cameraPosition.position;
        camera.target = menuTarget; // Set the target to the menu target
        camera.offset = new Vector3(0, 2, -20); // Adjust the offset as needed
